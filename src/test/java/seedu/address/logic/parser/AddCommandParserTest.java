...
import static seedu.address.logic.commands.CommandTestUtil.VALID_MEMBER;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + VALID_MEMBER + NAME_DESC_AMY + PHONE_DESC_AMY
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + TAG_DESC_FRIEND, new AddMemberCommand(expectedMember));

        // multiple names - last name accepted
        assertParseSuccess(parser, VALID_MEMBER + NAME_DESC_BOB + NAME_DESC_AMY + PHONE_DESC_AMY
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + TAG_DESC_FRIEND, new AddMemberCommand(expectedMember));

        // multiple phones - last phone accepted
        assertParseSuccess(parser, VALID_MEMBER + NAME_DESC_AMY + PHONE_DESC_BOB + PHONE_DESC_AMY
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + TAG_DESC_FRIEND, new AddMemberCommand(expectedMember));

        // multiple emails - last email accepted
        assertParseSuccess(parser, VALID_MEMBER + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_BOB
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + TAG_DESC_FRIEND, new AddMemberCommand(expectedMember));

        // multiple addresses - last address accepted
        assertParseSuccess(parser, VALID_MEMBER + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, VALID_MEMBER + VALID_NAME_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY,
                expectedMessage);

        // missing phone prefix
        assertParseFailure(parser, VALID_MEMBER + NAME_DESC_AMY + VALID_PHONE_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY,
                expectedMessage);

        // missing email prefix
        assertParseFailure(parser, VALID_MEMBER + NAME_DESC_AMY + PHONE_DESC_AMY + VALID_EMAIL_AMY + ADDRESS_DESC_AMY,
                expectedMessage);

        // missing address prefix
        assertParseFailure(parser, VALID_MEMBER + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + VALID_ADDRESS_AMY,
                expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_MEMBER + VALID_NAME_AMY + VALID_PHONE_AMY + VALID_EMAIL_AMY
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser, VALID_MEMBER + INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Name.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, VALID_MEMBER + NAME_DESC_BOB + INVALID_PHONE_DESC + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, VALID_MEMBER + NAME_DESC_BOB + PHONE_DESC_BOB + INVALID_EMAIL_DESC
                + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Email.MESSAGE_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, VALID_MEMBER + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
