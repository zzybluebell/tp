...
public class TypicalMembers {
    ...
    public static final Member ALICE = new MemberBuilder().withId("00001").withName("Alice Pauline")
            ...
            .withPhone("94351253").withTimestamp("1609459200000").withCredit("610")
            .withTransactions(
                    new Transaction(new Id("000001"), new Timestamp("1611100800000"), new Billing("567.54")),
                    new Transaction(new Id("000002"), new Timestamp("1611187200000"), new Billing("43.34"))
            ).withReservations(
    ...
    public static final Member BENSON = new MemberBuilder().withId("00002").withName("Benson Meier")
            ...
            .withPhone("98765432").withTimestamp("1609462800000").withCredit("645")
            .withTransactions(
                    new Transaction(new Id("000001"), new Timestamp("1611104400000"), new Billing("645.39")))
    ...
    public static final Member CARL = new MemberBuilder().withId("00003").withName("Carl Kurz")
            ...
            .withTimestamp("1609466400000").withCredit("272")
            .withTransactions(
                    new Transaction(new Id("000001"), new Timestamp("1611108000000"), new Billing("272.57")))
    ...
    public static final Member DANIEL = new MemberBuilder().withId("00004").withName("Daniel Meier")
            ...
            .withTimestamp("1609470000000").withCredit("0").withTags("friends").build();
    public static final Member ELLE = new MemberBuilder().withId("00005").withName("Elle Meyer")
            ...
            .withTimestamp("1609473600000").withCredit("0").build();
    public static final Member FIONA = new MemberBuilder().withId("00006").withName("Fiona Kunz")
            ...
            .withTimestamp("1609477200000").withCredit("0").build();
    public static final Member GEORGE = new MemberBuilder().withId("00007").withName("George Best")
            ...
            .withTimestamp("1609480800000").withCredit("0").build();
    ...
    public static final Member HOON = new MemberBuilder().withId("00008").withName("Hoon Meier")
            ...
            .withTimestamp("1609484400000").withCredit("0").build();
    public static final Member IDA = new MemberBuilder().withId("00009").withName("Ida Mueller")
            ...
            .withTimestamp("1609488000000").withCredit("0").build();
    ...
    public static final Member AMY = new MemberBuilder().withId(VALID_ID_AMY).withName(VALID_NAME_AMY)
            ...
            .withTimestamp(VALID_REGISTRATION_TIMESTAMP_AMY).withCredit(VALID_CREDIT_AMY)
            .withTransactions(new Transaction(new Id(VALID_TRANSACTION_ID_200_AMY),
    ...
    public static final Member BOB = new MemberBuilder().withId(VALID_ID_BOB).withName(VALID_NAME_BOB)
            ...
            .withTimestamp(VALID_REGISTRATION_TIMESTAMP_BOB).withCredit(VALID_CREDIT_BOB)
            .withTransactions(
                    new Transaction(new Id(VALID_TRANSACTION_ID_200_BOB),
                            new Timestamp(VALID_TRANSACTION_TIMESTAMP_200), new Billing(VALID_TRANSACTION_BILLING_200)),
                    new Transaction(new Id(VALID_TRANSACTION_ID_300_BOB),
