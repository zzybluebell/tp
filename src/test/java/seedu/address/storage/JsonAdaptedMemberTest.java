...
public class JsonAdaptedMemberTest {
    ...
    public void toModelType_invalidId_throwsIllegalValueException() {
        JsonAdaptedMember member =
                new JsonAdaptedMember(INVALID_ID, VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_REGISTRATION_TIMESTAMP, VALID_CREDIT, VALID_TRANSACTIONS, VALID_RESERVATIONS, VALID_TAGS);
    ...
    public void toModelType_invalidTimestamp_throwsIllegalValueException() {
        JsonAdaptedMember member =
                new JsonAdaptedMember(VALID_ID, VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        INVALID_REGISTRATION_TIMESTAMP, VALID_CREDIT, VALID_TRANSACTIONS, VALID_RESERVATIONS,
                        VALID_TAGS);
    ...
    public void toModelType_nullTimestamp_throwsIllegalValueException() {
        JsonAdaptedMember member =
                new JsonAdaptedMember(VALID_ID, VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        null, VALID_CREDIT, VALID_TRANSACTIONS, VALID_RESERVATIONS, VALID_TAGS);
    ...
    public void toModelType_invalidCredit_throwsIllegalValueException() {
        JsonAdaptedMember member =
                new JsonAdaptedMember(VALID_ID, VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_REGISTRATION_TIMESTAMP, INVALID_CREDIT, VALID_TRANSACTIONS, VALID_RESERVATIONS,
                        VALID_TAGS);
    ...
    public void toModelType_nullCredit_throwsIllegalValueException() {
        JsonAdaptedMember member =
                new JsonAdaptedMember(VALID_ID, VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_REGISTRATION_TIMESTAMP, null, VALID_TRANSACTIONS, VALID_RESERVATIONS, VALID_TAGS);
        String expectedMessage = String.format(
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedMember member =
                new JsonAdaptedMember(VALID_ID, VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_REGISTRATION_TIMESTAMP, VALID_CREDIT, VALID_TRANSACTIONS, VALID_RESERVATIONS,
                        invalidTags);
