...
public class SampleDataUtil {
    public static Member[] getSampleMembers() {
        return new Member[] {
            new Member(new seedu.address.model.member.Id("10001"), new Name("Alex Yeoh"), new Phone("87438807"),
                    new Email("alexyeoh@example.com"), new Address("Blk 30 Geylang Street 29, #06-40"),
                    new Timestamp("1609545600000"), new Credit("90"), new Point("90"),
                    getTransactionList(new Transaction(new seedu.address.model.transaction.Id("100001"),
            ...
            new Member(new seedu.address.model.member.Id("10002"),
                    ...
                    getTransactionList(
                            new Transaction(new seedu.address.model.transaction.Id("100001"),
                                    new Timestamp("1611104400000"), new Billing("200.12")),
                            new Transaction(new seedu.address.model.transaction.Id("100002"),
                                    new Timestamp("1611190800000"), new Billing("325.30"))),
                    getReservationList(
                            new Reservation(new seedu.address.model.reservation.Id("100001"),
            ...
            new Member(new seedu.address.model.member.Id("10004"),
                    ...
                    getTransactionList(
                            ...
                            new Transaction(new seedu.address.model.transaction.Id("100003"),
